...
## Contributing
Parm is in a very early state, so any and all PRs are welcome. If you want to contribute to a new feature not already on the [roadmap](/docs/roadmap.md), please [create an issue](https://github.com/alxrw/parm/issues/new) first, or check if an issue has already been created for it.
...
Parm tries its best to adhere to current conventions of open-source software when parsing repositories. If there's something I'm missing, please [create an issue](https://github.com/alxrw/parm/issues/new).
